...
import de.homeworkproject.homework.internal.event.CDKEvent;
...
import de.homeworkproject.homework.internal.network.requests.addhw.RequestAddHW;
import de.homeworkproject.homework.internal.network.requests.attachments.GETAttachmentFTRequest;
import de.homeworkproject.homework.internal.network.requests.attachments.POSTAttachmentFTRequest;
import de.homeworkproject.homework.internal.network.requests.attachments.ReceiveAttachmentRequest;
import de.homeworkproject.homework.internal.network.requests.attachments.StoreAttachmentRequest;
import de.homeworkproject.homework.internal.network.requests.delhw.RequestDelHW;
import de.homeworkproject.homework.internal.network.requests.edithw.RequestEditHW;
import de.homeworkproject.homework.internal.network.requests.gethw.RequestGetHW;
import de.homeworkproject.homework.internal.network.requests.list.RequestList;
import de.homeworkproject.homework.internal.network.requests.login.RequestLogin;
