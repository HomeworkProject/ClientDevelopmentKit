 ...
 */
public class POSTAttachmentFTRequest implements Runnable, IHWFutureProvider<IHWStreamWriteResult> {
    ...
    public POSTAttachmentFTRequest(LMgr r, IHWAttachment location, RequestMgr reqMgr, HWMgr hwMgr) {
        this.r = r;
