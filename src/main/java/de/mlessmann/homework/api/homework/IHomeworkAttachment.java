package de.mlessmann.homework.api.homework;

import de.mlessmann.common.annotations.NotNull;
import de.mlessmann.common.annotations.Nullable;
import de.mlessmann.homework.internal.homework.HomeworkAttachment;
import org.json.JSONObject;

/**
 * Created by Life4YourGames on 03.11.16.
 */
public interface IHomeworkAttachment {
    ...
    public class Builder {
        public static IHomeworkAttachment.Builder builder() {
            return new Builder();
        }
        ...
        public IHomeworkAttachment build() {
            ...
            j.put("virtual", true);
            return new HomeworkAttachment(j);
        }
    }
}